...
{
    public class AccelerometerDataCollector
    {
        ...
        public void Start()
        {
            ...
            _timer = new Timer(TimerCallback, null, TimeSpan.FromMilliseconds(500), TimeSpan.FromMilliseconds(500));
        ...
        {
            DataRecorder.GetInstance().AddAccelerometerPoint(_offset, _maxValue);
